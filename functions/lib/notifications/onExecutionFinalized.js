...
exports.onExecutionFinalized = void 0;
const firestore_1 = require("firebase-functions/v2/firestore");
const admin = require("firebase-admin");
exports.onExecutionFinalized = (0, firestore_1.onDocumentUpdated)("companies/{companyId}/serviceOrders/{orderId}/executions/{execId}", async (event) => {
...
//# sourceMappingURL=onExecutionFinalized.js.map